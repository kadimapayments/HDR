...
export const MARQUEE_BRANDS = [
  { name: "Fleetwood", slug: "fleetwood", logo: "/images/manufacturers/fleetwood.png", scale: 0.95 },
  ...
  { name: "TruStile", slug: "trustile", logo: "/images/interiors/trustile.webp", scale: 0.55, link: "/interiors" },
] as const;
